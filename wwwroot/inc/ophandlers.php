...
function updateFile ()
{
	...
	return showFuncMessage (__FUNCTION__, 'OK', array ($file_name));
}
...
function editIPv4Net ()
{
	...
	return showFuncMessage (__FUNCTION__, 'OK', array ("${netdata['ip']}/${netdata['mask']}"));
}
...
function editUserProperties ()
{
	...
	print_r($user);
	return showFuncMessage (__FUNCTION__, 'OK', array($user['user_name']));
}
