...
function renderDepot ()
{
	...
	if (! ($cellfilter['is_empty'] && renderEmptyResults ($cellfilter, 'objects', getEntitiesCount ('object'))))
	{
...
function renderAddMultipleObjectsForm ()
{
	...
	echo '<table border=0 align=center>';
	echo "<tr><th class='tdright'>Tags:</th>";
	...
	echo '<table border=0 align=center>';
	echo "<tr><th class='tdright'>Tags:</th><td clas='tdleft' align='left'>";
	printTagsPicker ();
	echo "</td></tr>";
	echo "<tr><th>Object type</th><th>Common name</th></tr>";
	for ($i = 0; $i < $max; $i++)
	{
		echo '<tr><td>';
		// Don't employ DEFAULT_OBJECT_TYPE to avoid creating ghost records for pre-selected empty rows.
	...
	echo "<table border=0 align=center>";
	echo "<tr><th>Type:</th><td class='tdleft'>";
	...
	printTagsPicker ();
	echo "</td></tr>";
	echo "<tr><th>Names:<th><textarea name=namelist cols=40 rows=15>";
